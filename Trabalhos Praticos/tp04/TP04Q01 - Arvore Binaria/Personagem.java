...
class ArvoreABP {
    ...
    public void inserirABP(Personagem x) {
    ...
    private int compararNomes(String nome1, String nome2) {
        ...
        // Use compareToIgnoreCase(nome2) para comparar sem distinção de maiúsculas e
        // minúsculas
    }

    private NoABP inserirABP(NoABP i, Personagem x) {
        if (i == null) {
            i = new NoABP(x);
    ...
    private void caminharCentral(NoABP i) {
        if (i != null) {
            ...
            System.out.print(i.personagem + " "); // Pre ordem, sysout antes, pos ordem depois
