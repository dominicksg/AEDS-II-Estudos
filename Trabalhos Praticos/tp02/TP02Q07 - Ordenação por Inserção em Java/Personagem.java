...
class Personagem {
    ...
    public static int[] InsertionSort(Personagem[] vetor) {
        int[] info = new int[2]; // info[0] = comparacoes, info[1] = movimentacoes

        for (int i = 1; i < vetor.length && vetor[i] != null; i++) {
    ...
    public static void log(long tempoExecucao, int info[]) {
        File log = new File("831566_insercao.txt");
