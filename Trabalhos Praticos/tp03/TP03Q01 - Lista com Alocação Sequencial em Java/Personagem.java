...
class ListaPersonagem {
    ...
    public void InserirInicio(Personagem personagem) throws Exception {
        ...
        for (int i = tam; i > 0; i--)
            array[i] = array[i - 1];
        array[0] = personagem.clone(personagem);
    ...
    public void InserirFim(Personagem personagem) throws Exception {
        ...
        array[tam++] = personagem.clone(personagem);
    }
    ...
    public void Inserir(String posSTRING, Personagem personagem) throws Exception {
        ...
        array[pos] = personagem.clone(personagem);
        tam++;
...
public class Personagem {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ListaPersonagem lista = new ListaPersonagem(300);
